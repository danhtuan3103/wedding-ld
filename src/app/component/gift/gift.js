import { groomBank } from "@/app/configs/ui";
  ...
  return (
    <div className={cx("wrapper")}>
      ...
      <div className={cx("content")}>
        <img
          className={cx("img")}
          src="https://res.cloudinary.com/do6sozxbo/image/upload/v1748609882/wedding-linh-dung/hi3.jpg"
        />
        ...
        <CopyToClipboard text={groomBank.bankNumber} onCopy={handleCopy}>
